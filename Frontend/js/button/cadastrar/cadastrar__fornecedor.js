const buttonCadastrarfornecedor = document.getElementById(
  "button__cadastrar--fornecedor"
);

buttonCadastrarfornecedor.addEventListener("click", (event) => {
  event.preventDefault();
  event__buttonCadastrar__Cadastrafornecedor();
});

function event__buttonCadastrar__Cadastrafornecedor() {
  ...
  if (
    ...
    fetch("http://localhost:3000/api/cadastro/fornecedor", {
      method: "POST",
